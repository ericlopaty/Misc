...
Public Class MainForm
    ...
    Private _oQMgr As MQQueueManager = Nothing
    Private _bSendReplyPressed As Boolean = False
    Private _strSendReplyQueue As String
    Private _bytMessageID As Byte()
    Private _bTimerEnabled As Boolean = False
    Private _lngPolicyNo As Long = 10000000
    Private _oCopyClipboardTextBox As TextBox
    Private _bProcessCompleted As Boolean = True
